            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.8125rem', color: '#64748b' }}>
                  Class <strong>{selectedStudent.class}</strong> ({selectedStudent.section || 'A'}) • Roll No <strong>{selectedStudent.rollNo}</strong> • Enrolled Student
                </div>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: '0.76rem', color: isSelected ? '#d1fae5' : '#64748b' }}>
