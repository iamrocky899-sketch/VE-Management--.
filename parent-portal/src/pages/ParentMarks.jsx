        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            ...
            <p style={{ fontSize: '0.85rem', opacity: 0.92, margin: 0 }}>
              Class <strong>{selectedStudent.class}</strong> • Section <strong>{selectedStudent.section || 'A'}</strong> • Roll No <strong>{selectedStudent.rollNo}</strong> • Official Academic Record
            </p>
          </div>
