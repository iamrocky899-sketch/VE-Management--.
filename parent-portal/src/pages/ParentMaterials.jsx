...
import {
  ...
  FileText, Layers, AlertCircle, Users, CheckCircle2
} from 'lucide-react';
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
              ...
              <span style={{ fontSize: '0.6875rem', fontWeight: 700, background: '#ffffff', color: '#047857', padding: '2px 8px', borderRadius: '6px' }}>
