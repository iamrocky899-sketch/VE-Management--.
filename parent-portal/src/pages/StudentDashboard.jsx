...
export default function StudentDashboard({ setActivePage }) {
  ...
  const fetchDashboard = async (isManual = false) => {
    ...
    try {
      const res = await ApiService.getStudentDashboard(user?.token);
      ...
      if (res && res.success && res.data) {
        ...
        setError(res?.error?.message || 'Unable to load student dashboard.');
      }
    } catch (e) {
  ...
  return (
    <div className="student-dashboard-container animate-fade-in">
      ...
      <div
        className="card student-hero-banner"
        style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <h1 style={{ fontSize: '1.45rem', fontWeight: 800, margin: '2px 0 4px 0', lineHeight: 1.2 }}>
                {getGreeting()}, {student.studentName}!
              </h1>
              <p style={{ fontSize: '0.85rem', opacity: 0.92, margin: 0 }}>
                Class <strong>{student.class}</strong> • Section <strong>{student.section || 'A'}</strong> • Roll No <strong>{student.rollNo}</strong> • IT/ITeS Vocational
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" style={{ marginBottom: '20px' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginBottom: '4px' }}>
            ...
            <span style={{ fontSize: '0.78rem', color: '#64748b' }}>
              ({evaluatedMarks.length} Exam Records)
            </span>
          </div>
        ...
        >
          ...
          <div style={{ fontSize: '0.75rem', color: '#64748b' }}>
            {assignmentsList.length > 0 ? assignmentsList[0].title : 'All submissions up to date'}
          </div>
      ...
      {/* Two Column Layout: Left Column (Notices & Study Materials) / Right Column (Calendar & Shortcuts) */}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '0.8125rem', color: '#166534', margin: '2px 0 0 0' }}>
                  Structured Units & Q&A for <strong>Main Book</strong> & <strong>Employability Skill</strong>
                </p>
              </div>
            </div>
            <button
          ...
          <div className="card" style={{ padding: '20px', borderRadius: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '8px' }}>
              <button
                ...
                className="btn-secondary"
                onClick={() => setActivePage('attendance')}
                style={{ justifyContent: 'flex-start', padding: '10px 12px', fontSize: '0.8125rem' }}
              >
