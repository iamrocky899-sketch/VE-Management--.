                    ...
                    >
                      ...
                      <td style={{ padding: '12px 16px' }}>
                        ...
                        <div style={{ fontSize: '0.75rem', color: '#64748b' }}>
                          ID: <span style={{ fontFamily: 'monospace' }}>{s.studentId}</span>
                        </div>
                      </td>
                      <td style={{ padding: '12px 16px' }}>
                      ...
                      <td style={{ padding: '12px 16px' }}>
                        ...
                        <div style={{ fontSize: '0.75rem', color: '#64748b' }}>Sec {s.section || 'A'}</div>
                      </td>
                      <td style={{ padding: '12px 16px' }}>
                      ...
                      <td style={{ padding: '12px 16px' }}>
                        <div style={{ color: '#334155' }}>{s.fatherName || s.motherName || 'Parent'}</div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
                    <div>
                      ...
                      <div style={{ fontSize: '0.85rem', color: '#94a3b8', display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                        ...
                        <span>Class: <strong>{profileData.student.class} ({profileData.student.section || 'A'})</strong></span>
