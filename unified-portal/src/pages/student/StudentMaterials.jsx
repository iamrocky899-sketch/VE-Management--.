...
import {
  ...
  FileText, Layers, AlertCircle, Sparkles, BookMarked, Download
} from 'lucide-react';
        ...
        <div className="materials-hero-content">
          <div>
            <div className="materials-hero-badges">
              ...
              <span className="badge-student-class" style={{ color: '#15803d' }}>
                CLASS {studentClass}
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="card" style={{ padding: '20px', borderRadius: '16px' }}>
            ...
            {/* Attached Official PDF Material (Private B2 Gateway) */}
